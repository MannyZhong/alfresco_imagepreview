...
public class QuickShareImagePreview extends QuickShareThumbnailContentGet {
	private PreviewService previewService;
	private static final Log logger = LogFactory.getLog(QuickShareImagePreview.class);
...
//		String previewName = url.substring(url.lastIndexOf("/") + 1, url.lastIndexOf("."));
		String previewName = previewService.getStoreId(url);
